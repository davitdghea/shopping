    ...
    return (
        <div className="hero">
            ...
            <div>
                        ...
                        <g clip-path="url(#clip0_0_4797)">
                            ...
                            <g filter="url(#filter0_d_0_4797)">
                                <mask id="path-5-inside-1_0_4797" fill="white">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M25.2501 19C23.65 23.0974 19.664 26 15 26C8.92487 26 4 21.0751 4 15C4 8.92487 8.92487 4 15 4C19.664 4 23.65 6.90264 25.2501 11H108C110.209 11 112 12.7909 112 15C112 17.2091 110.209 19 108 19H25.2501Z" />
                                </mask>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M25.2501 19C23.65 23.0974 19.664 26 15 26C8.92487 26 4 21.0751 4 15C4 8.92487 8.92487 4 15 4C19.664 4 23.65 6.90264 25.2501 11H108C110.209 11 112 12.7909 112 15C112 17.2091 110.209 19 108 19H25.2501Z" fill="#004CFF" />
                                <path d="M25.2501 19V17H23.8841L23.3871 18.2725L25.2501 19ZM25.2501 11L23.3871 11.7275L23.8841 13H25.2501V11ZM15 28C20.5151 28 25.2234 24.5664 27.1131 19.7275L23.3871 18.2725C22.0766 21.6283 18.8128 24 15 24V28ZM2 15C2 22.1797 7.8203 28 15 28V24C10.0294 24 6 19.9706 6 15H2ZM15 2C7.8203 2 2 7.8203 2 15H6C6 10.0294 10.0294 6 15 6V2ZM27.1131 10.2725C25.2234 5.43356 20.5151 2 15 2V6C18.8128 6 22.0766 8.37173 23.3871 11.7275L27.1131 10.2725ZM25.2501 13H108V9H25.2501V13ZM108 13C109.105 13 110 13.8954 110 15H114C114 11.6863 111.314 9 108 9V13ZM110 15C110 16.1046 109.105 17 108 17V21C111.314 21 114 18.3137 114 15H110ZM108 17H25.2501V21H108V17Z" fill="white" mask="url(#path-5-inside-1_0_4797)" />
                            </g>
                        </g>
                        <defs>
                ...
                <div style={{ backgroundColor: "#F9F9F9", display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ margin: "15px 0px" }}>
                    ...
                    <p style={{ fontSize: "13px" }}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore.</p>
                </div>
                <div style={{ margin: "15px 0px" }}>
                    <div style={{ margin: "3px 0px", display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ margin: "15px 0px" }}>
                    <div style={{ margin: "3px 0px", display: "flex", justifyContent: "space-between" }}>
                        <h5 style={{opacity:"0.6"}}>Shipped</h5>
                        <p style={{ background: "#E5EBFC", padding: "4px" }} >Expected on April,20</p>
                    </div>
                    <p style={{opacity:"0.6",fontSize: "13px"}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore.</p>
                </div>
            </div>
        </div>
    )
